	...
	<div id="page">
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li class="current_page_item"><a href="#">Pannir</a></li>
		...
		<div id="content">
			<div>
				...
				<center><H2>PANEER</H2><IMG border=0 alt="" 
src="images/pannir.jpg" width=400
height=200> </center>
<P><FONT color=#33cc00 size=3>It is best for lowering body, back and joint pain, 
It is best for weight loss,<BR>It is best remedy for osteoporosis, Controls and 
reduces blood pressure,<BR>Improve digestion, Improves the metabolism rate, 
Keeps you feel full.<BR>Cures and heals acne &amp; acne scars, Exfoliates dead 
skin from body,<BR>Free from radicals </FONT></P>
