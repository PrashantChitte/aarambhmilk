	...
	<div id="page">
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li class="current_page_item"><a href="#">Milk Powder</a></li>
		...
		<div id="content">
			<div>
					...
					<CENTER>
<H2>MILK POWDER</H2><IMG border=0 alt="" 
src="images/milkpowder.jpg" width=400 
height=200> 
<P><FONT color=#33cc00 size=3>Milk powder, was invented by a Russian Chemist 
called M.Dirchoff . <BR>The smell and taste of Milk powder is weaker tha fresh 
milk.<BR>Lightweight and easy to carry.<BR>Used to make various recipes where 
fresh milk would not be suitable.<BR></P></CENTER>
