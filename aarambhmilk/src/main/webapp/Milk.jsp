	...
	<div id="page">
		<div id="sidebar1" class="sidebar">
			<ul>
				...
				<li>
					<h2>All Products</h2>
					<ul>
						<li  class="current_page_item"><a href="#">Milk</a></li>
		...
		<div id="content">
			<div>
					...
					<CENTER>
<H2>MILK</H2><IMG border=0 alt="" 
src="images/milk.jpg" width=400 
height=200> 
<P><FONT color=#33cc00 size=3>Cow's milk is full of protein, minerals, 
carbohydrates <BR>and vitamin D. Plus is has much needed calcium for strong bone 
health and<BR>potassium for muscles. For those who have lactose intolerance, 
<BR>varieties of milk such as soy, almond and rice milk are available. 
</P></CENTER>
...
<div id="footer">
	<p class="copyright">&copy;&nbsp;&nbsp;2009 All Rights Reserved &nbsp;&bull;&nbsp; Design by <a href="http://www.freecsstemplates.org/">Scoopen Group</a>.</p>
