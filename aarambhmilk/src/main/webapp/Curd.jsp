	...
	<div id="page">
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li  class="current_page_item"><a href="#">Curd</a></li>
		...
		<div id="content">
			<div>
					...
					<CENTER>
<H2>CURD</H2><IMG border=0 alt="" 
src="images/curd.jpg" width=400 
height=200> 
<P><FONT color=#33cc00 size=3>Curd or Yogurt is in great demand, especially in 
summer season. <BR>Curd is used to make multiple Dahi dishes,which have<BR>their 
own significance from health point of view.<BR>Curd Lassi is quite popular dish 
in northern India in summer season. </P></CENTER>
