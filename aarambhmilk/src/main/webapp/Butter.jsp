	...
	<div id="page">
			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li  class="current_page_item"><a href="#">Butter</a></li>
		...
		<div id="content">
			<div>
					...
					<CENTER>
<H2>BUTTER </H2><IMG border=5 alt="" 
src="images/butter.jpg" width=400 
height=200> 
<P><FONT color=#33cc00 size=3>Buttermilk has acid in it which fights germs and 
bacteria and<BR>helps clear stomach and aid digestion.It is very helpful for 
those who<BR>are looking to lose weight.It is a rich source of Vitamin B12 
<BR>and so is believed to help fight anaemia and stress. 
</P></CENTER>
